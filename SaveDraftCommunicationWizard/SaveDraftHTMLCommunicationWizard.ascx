<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveDraftHTMLCommunicationWizard.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.SaveDraftCommunicationWizard.SaveDraftHTMLCommunicationWizard" %>
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlEmailEditor" CssClass="js-navigation-panel" runat="server" Visible="false">
                    ...
                    <div class="actions margin-t-lg">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" Text="Save as Draft" CssClass="btn btn-default js-saveeditorhtml" CausesValidation="true" ValidationGroup="vgConfirmation" OnClick="btnSaveAsDraftAlternate_Click" />
                    </div>
