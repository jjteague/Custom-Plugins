...
//Adjustments made to Save as Draft button by Ethan Widen
//DTS Church
// On: 2-17-2020
...
namespace RockWeb.Plugins.com_DTS.SaveDraftCommunicationWizard
{
    /// <summary>
    /// 
    /// </summary>
    [DisplayName( "Save as Draft in HTML Editor Communication Entry Wizard" )]
    [Category( "com_DTS > Communication" )]
    [Description( "Used for creating and sending a new communications such as email, SMS, etc. to recipients. The Save as Draft button shows up on the HTML editor screen" )]
    ...
    public partial class SaveDraftHTMLCommunicationWizard : RockBlock, IDetailBlock
    {
        #region Fields
...
sendCountTerm.PluralizeIf( sendCount != 1 ) );
        ...
        /// Shows the confirmation.
        /// </summary>
        private void ShowConfirmationAlternate()
        {
            pnlConfirmation.Visible = true;
            SetNavigationHistory(pnlConfirmation);
...
sendCountTerm.PluralizeIf(sendCount != 1));
        ...
        /// <summary>
        /// Handles the Click event of the btnSaveAsDraftAlternate control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        protected void btnSaveAsDraftAlternate_Click(object sender, EventArgs e)
        {
            if (!ValidateSendDateTime())
            {
                return;
            ...
            ShowResultEmailEditor("The communication has been saved", communication);
        }

        private void ConfirmationFake()
        {
            ifEmailDesigner.Attributes["srcdoc"] = hfEmailEditorHtml.Value;
            pnlEmailEditor.Visible = true;

      
            //ShowConfirmationAlternate();
        ...
        /// <param name="message">The message.</param>
        /// <param name="communication">The communication.</param>
        private void ShowResultEmailEditor(string message, Rock.Model.Communication communication)
        {
            //SetNavigationHistory(pnlResult);
            //pnlConfirmation.Visible = false;
            pnlResult.Visible = true;
