<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonMergeWithForeignId.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.MergeBlockWithForeignId.PersonMergeWithForeignId" %>
