...
namespace RockWeb.Plugins.com_DTS.GroupAttendanceDetailWithAnonymous
{
    [DisplayName( "Group Attendance Detail With Anonymous Value" )]
    [Category( "Groups" )]
    ...
    public partial class GroupAttendanceDetailWithAnonymous : RockBlock
    {
        #region Fields
        ...
        protected void ShowDetails()
        {
            ...
            else
            {
                ...
                if ( _occurrence.Id > 0 )
                {
                    numbAnonymousValue.Text = _occurrence.AnonymousAttendanceCount.ToString();
...
", cbDidNotMeet.ClientID );
        ...
        protected bool SaveAttendance()
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                occurrence.AnonymousAttendanceCount = Int32.Parse(numbAnonymousValue.Text);
