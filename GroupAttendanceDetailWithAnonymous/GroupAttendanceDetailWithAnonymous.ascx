<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupAttendanceDetailWithAnonymous.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.GroupAttendanceDetailWithAnonymous.GroupAttendanceDetailWithAnonymous" %>
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlDetails" runat="server">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <Rock:NumberBox runat="server" ID="numbAnonymousValue" NumberType="Integer" Label="# of Anonymous Attendees" MinimumValue="0"></Rock:NumberBox>
                        </div>
                    </div>
