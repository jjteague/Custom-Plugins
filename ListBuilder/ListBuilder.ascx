<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListBuilder.ascx.cs" Inherits="Plugins.com_DTS.Misc.ListBuilder" %>
<style>
    .nameCss {
        width: 40px;
    }
    ...
    <div class="col-md-3">
        <div class="panel panel-block">
            <div class="panel-heading">
                <h4 class="panel-title">List Builder</h4>
            </div>
            <div class="row">
                <div class="col-md-12 text-center">
                    <span>Paste Person Id's:</span>
                </div>
            </div>
            <div class="row">
