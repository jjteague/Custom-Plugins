<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonWithSearchValue.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.CheckInPersonProfileSearchValue.PersonWithSearchValue" %>
            ...
            <Rock:Grid ID="gHistory" runat="server" DisplayType="Light" AllowPaging="false" CssClass="table-condensed">
                <Columns>
                    ...
                    <Rock:RockTemplateField HeaderText="Code">
                     ...
                     <Rock:RockTemplateField HeaderText="Search Value">
                        <ItemTemplate>
                            <asp:Literal ID="lActive" runat="server"></asp:Literal><br />
                            <%# Eval("SearchValue") %>
                        </ItemTemplate>
