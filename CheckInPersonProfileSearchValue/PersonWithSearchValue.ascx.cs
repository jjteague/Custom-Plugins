...
namespace RockWeb.Plugins.com_DTS.CheckInPersonProfileSearchValue
{
    /// <summary>
    /// Block used to display person and details about recent check-ins
    /// </summary>
    [DisplayName( "Person Profile with Search Value Column" )]
    [Category( "com_DTS > Check-in Manager" )]
    ...
    public partial class PersonWithSearchValue : Rock.Web.UI.RockBlock
    {
        ...
        private void ShowDetail( Guid personGuid )
        {
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                foreach ( var attendance in attendances.Where( a => a.IsActive ) )
                {
                    ...
                    qryParam["SearchValue"] = attendance.SearchValue;
