...
/// </summary>
[DisplayName( "Dropdown Filter Calendar Lava" )]
[Category( "DTS > Event" )]
[Description( "Renders a particular calendar using Lava and filters as dropdowns." )]
...
public partial class DropdownFilterCalendarLava : Rock.Web.UI.RockBlock
{
	#region Fields
	...
	private bool SetFilterControls()
	{
		...
		pnlFilters.Visible = showFilter;
		 pnlList.CssClass = showFilter ? "col-md-8 col-xs-12" : "col-md-8 col-xs-12";
