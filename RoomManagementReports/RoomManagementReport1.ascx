<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RoomManagementReport1.ascx.cs" Inherits="RoomManagementReport1" %>
<style>
    ...
    <div class="col-xs-12">
        <div class="panel panel-block">
            <div class="panel-heading hidden-print">
                <h1 class="panel-title">Report For Each Location</h1>
