<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupScheduleStatusBoardIgnoreTestSchedule.ascx.cs" Inherits="RockWeb.Plugins.com_DTS.GroupScheduleStatusBoardTestScheduleHide.GroupScheduleStatusBoardIgnoreTestSchedule" %>
